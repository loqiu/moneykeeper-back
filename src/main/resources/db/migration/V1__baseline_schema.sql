CREATE TABLE `users` (
  ...
  UNIQUE KEY `uk_users_user_pin` (`user_pin`)
...
CREATE TABLE `categories` (
  ...
  CONSTRAINT `fk_categories_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `moneykeeper` (
  ...
  `deleted_time` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_mk_user_date` (`user_id`, `transaction_date`),
  KEY `idx_mk_user_type` (`user_id`, `type`),
  KEY `idx_mk_category` (`category_id`),
  CONSTRAINT `fk_moneykeeper_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_moneykeeper_category` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
